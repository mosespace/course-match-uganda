...
export default function page() {
  return (
    <>
      <section>
        <div className="relative justify-center h-screen z-0 mx-auto items-center space-y-4 max-w-3xl pb-24 pt-16 text-center">
          <div>
              ...
              {howItWorks.map((item, i) => (
                <div key={i} className="relative">
                  <div className="border-[#f4f4f4]/50 border rounded-lg shadow-sm p-8 h-full relative z-10 hover:shadow-md transition-shadow">
                    <div
                      className={`bg-violet-600 z-40 text-5xl p-1 font-bold opacity-10 absolute -top-2 -left-2`}
                    >
                      {item.step}
                    </div>
                    <div
