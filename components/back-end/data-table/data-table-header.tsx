...
// import { BusForm } from '@/components/admin/buses/bus-form';
// import { RouteForm } from '@/components/admin/buses/route-form';
// import { ScheduleForm } from '@/components/admin/buses/schedule-form';
// import { TerminalForm } from '@/components/admin/terminal-form';
import {
  Dialog,
  DialogClose,
  DialogContent,
...
interface IProps {
  ...
  model: string;
  showImport?: boolean;
  terminals?: ISelectProps[] | null;
  buses?: ISelectProps[] | null;
  routes?: ISelectProps[] | null;
}
export default function TableHeader({
  ...
  //               };
  //             });
  //             // await createBulkCategories(categories as []);
  //           }
  //           setLoading(false);
            ...
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[750px]">
                <ScrollArea className="h-[600px]">
                  <DialogHeader>
                    <DialogTitle className="sr-only">{linkTitle}</DialogTitle>
                  </DialogHeader>
                  {/* forms-here*/}
                  {renderForm()}
                </ScrollArea>
